...
class BrokerTestCase(BaseTestCase):
    def testOneCancelsAnother(self):
        ...
        def onOrderEvent(broker_, orderEvent):
            if orderEvent.getEventType() == stockbroker.OrderEvent.Type.FILLED and orderEvent.getOrder().getId() == orders["sell"].getId():
                brk.cancelOrder(orders["stoploss"])

        # Buy order.
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        ...
        order = brk.createOptionLimitOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 11, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        orders["sell"] = order
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        order = brk.createOptionStopOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 8, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testRegressionGetActiveOrders(self):
        ...
        def onOrderEvent(brk, orderEvent):
            if orderEvent.getEventType() != stockbroker.OrderEvent.Type.SUBMITTED:
        ...
        brk.getOrderUpdatedEvent().subscribe(onOrderEvent)
        o1 = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(o1.getSubmitDateTime(), None)
        brk.submitOrder(o1)
        self.assertEquals(o1.getSubmitDateTime(), barFeed.getCurrentDateTime())
        o2 = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testVolumeLimitMinuteBars(self):
        ...
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 3, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
    ...
    def testCancelationEvent(self):
        ...
        order = brk.createOptionLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 2, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        ...
        self.assertTrue(stockbroker.Order.State.CANCELED in orderStates)
    ...
    def testSkipOrderSubmittedDuringEvent(self):
        ...
        def onOrderEvent(broker_, orderEvent):
            if orderEvent.getEventType() != stockbroker.OrderEvent.Type.SUBMITTED:
                ...
                newOrder = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        ...
        firstOrder = brk.createOptionLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 2, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testPartialFillAndCancel(self):
        ...
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        ...
        self.assertEqual(cb.events[0].getEventType(), stockbroker.OrderEvent.Type.SUBMITTED)
        self.assertEqual(cb.events[1].getEventType(), stockbroker.OrderEvent.Type.ACCEPTED)
        self.assertEqual(cb.events[2].getEventType(), stockbroker.OrderEvent.Type.PARTIALLY_FILLED)
        self.assertEqual(cb.events[3].getEventType(), stockbroker.OrderEvent.Type.CANCELED)

    def testVolumeLimitPerBar1(self):
        barFeed = self.buildBarFeed(BaseTestCase.TestInstrument, bar.Frequency.MINUTE)
        brk = self.buildBroker(1000, barFeed)

        order1 = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 2, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        ...
        order2 = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 2, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testVolumeLimitPerBar2(self):
        ...
        order1 = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order1.getSubmitDateTime(), None)
        brk.submitOrder(order1)
        self.assertEquals(order1.getSubmitDateTime(), barFeed.getCurrentDateTime())
        order2 = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order2.getSubmitDateTime(), None)
        brk.submitOrder(order2)
        self.assertEquals(order2.getSubmitDateTime(), barFeed.getCurrentDateTime())
    ...
    def testGetActiveOrders(self):
        ...
        order1 = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, "ins1", 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order1.getSubmitDateTime(), None)
        brk.submitOrder(order1)
        self.assertEquals(order1.getSubmitDateTime(), barFeed.getCurrentDateTime())
        order2 = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, "ins2", 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order2.getSubmitDateTime(), None)
        brk.submitOrder(order2)
        self.assertEquals(order2.getSubmitDateTime(), barFeed.getCurrentDateTime())
...
class MarketOrderTestCase(BaseTestCase):
    def testGetPositions(self):
        barFeed = self.buildBarFeed(BaseTestCase.TestInstrument, bar.Frequency.MINUTE)
        cash = 1000000
        brk = optbacktesting.OptionBroker(cash, barFeed)
        ...
        # Sell
        order = brk.createOptionMarketOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        brk.submitOrder(order)
        barFeed.dispatchBars(12.03, 12.03, 12.03, 12.03, 555.00)
        self.assertTrue(order.isFilled())
    ...
    def testBuyPartialWithTwoDecimals(self):
        class Broker(optbacktesting.OptionBroker):
        ...
        # Buy
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 500, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
    ...
    def testBuySellPartial(self):
        ...
        # Sell
        order = brk.createOptionMarketOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        # 0 should get filled.
    ...
    def testBuyAndSellInTwoSteps(self):
        ...
        # Buy
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 2, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        self.assertEqual(order.getFilled(), 0)
    ...
    def testBuyWithCommission(self):
        barFeed = self.buildBarFeed(BaseTestCase.TestInstrument, bar.Frequency.MINUTE)
        brk = self.buildBroker(1020, barFeed, commission=stockbacktesting.FixedPerTrade(10))

        # Buy
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 100, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        self.assertEqual(order.getFilled(), 0)
    ...
    def testSellShort_1(self):
        ...
        # Short sell
        order = brk.createOptionMarketOrder(optbroker.Order.Action.SELL_SHORT, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        self.assertEqual(order.getFilled(), 0)
        ...
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY_TO_COVER, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 1)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
    ...
    def testSellShort_2(self):
        ...
        # Buy 2 and earn 50
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY_TO_COVER, BaseTestCase.TestInstrument, 2, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 2)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
    ...
    def testSellShort_3(self):
        ...
        # Sell 2
        order = brk.createOptionMarketOrder(optbroker.Order.Action.SELL_SHORT, BaseTestCase.TestInstrument, 2, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 2)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
    ...
    def testSellShortWithCommission(self):
        ...
        commission = 10
        barFeed = self.buildBarFeed(BaseTestCase.TestInstrument, bar.Frequency.MINUTE)
        brk = self.buildBroker(1010, barFeed, commission=stockbacktesting.FixedPerTrade(commission))

        # Sell 10 shares
        order = brk.createOptionMarketOrder(optbroker.Order.Action.SELL_SHORT, BaseTestCase.TestInstrument, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 10)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        ...
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY_TO_COVER, BaseTestCase.TestInstrument, 19, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        self.assertEqual(order.getFilled(), 0)
    ...
    def testTradePercentageWithPartialFills(self):
        ...
        brk = self.buildBroker(1000, barFeed)
        commPercentage = 0.1
        brk.setCommission(stockbacktesting.TradePercentage(0.1))
    ...
    def testFixedPerTradeWithPartialFills(self):
        barFeed = self.buildBarFeed(BaseTestCase.TestInstrument, bar.Frequency.MINUTE)
        brk = self.buildBroker(1000, barFeed)
        brk.setCommission(stockbacktesting.FixedPerTrade(1.2))
    ...
    def testDailyMarketOnClose(self):
        ...
        # Buy
        order = brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 2, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", onClose=True)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
    ...
    def testIntradayMarketOnClose(self):
        ...
        with self.assertRaisesRegexp(Exception, "Market-on-close not supported with intraday feeds"):
            brk.createOptionMarketOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", onClose=True)
...
class LimitOrderTestCase(BaseTestCase):
    def testBuySellPartial(self):
        ...
        # Buy
        order = brk.createOptionLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 10, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        # 2 should get filled.
        ...
        # Sell
        order = brk.createOptionLimitOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 10, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        # 0 should get filled.
    ...
    def testBuyAndSell_HitTargetPrice(self):
        ...
        # Buy
        cb = OrderUpdateCallback(brk)
        order = brk.createOptionLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 10, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 1)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        ...
        # Sell
        cb = OrderUpdateCallback(brk)
        order = brk.createOptionLimitOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 15, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        self.assertEqual(order.getFilled(), 0)
    ...
    def testBuyAndSell_GetBetterPrice(self):
        ...
        # Buy
        cb = OrderUpdateCallback(brk)
        order = brk.createOptionLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 14, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 1)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
    ...
    def testBuyAndSell_GappingBars(self):
        ...
        cb = OrderUpdateCallback(brk)
        order = brk.createOptionLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 20, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        self.assertEqual(order.getFilled(), 0)
        ...
        cb = OrderUpdateCallback(brk)
        order = brk.createOptionLimitOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 30, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 1)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
    ...
    def testFailToBuy(self):
        ...
        order = brk.createOptionLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 5, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 1)
    ...
    def testBuy_GTC(self):
        ...
        order = brk.createOptionLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 4, 2, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        order.setGoodTillCanceled(True)
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 2)
...
class StopOrderTestCase(BaseTestCase):
    def testStopHitWithoutVolume(self):
        ...
        # Buy. Stop >= 15.
        order = brk.createOptionStopOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 15, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
    ...
    def testBuySellPartial_ActivateAndThenFill(self):
        ...
        # Sell. Stop <= 19.
        order = brk.createOptionStopOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 19, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        # 0 should get filled. The stop price should have not been hit.
    ...
    def testLongPosStopLoss(self):
        ...
        cb = OrderUpdateCallback(brk)
        order = brk.createOptionStopOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 9, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 1)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
    ...
    def testShortPosStopLoss(self):
        ...
        # Create stop loss order.
        cb = OrderUpdateCallback(brk)
        order = brk.createOptionStopOrder(optbroker.Order.Action.BUY_TO_COVER, BaseTestCase.TestInstrument, 11, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        self.assertEqual(order.getFilled(), 0)
...
class StopLimitOrderTestCase(BaseTestCase):
    def testStopHitWithoutVolume(self):
        ...
        # Buy. Stop >= 15. Buy <= 17.
        order = brk.createOptionStopLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 15, 17, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
    ...
    def testRegressionBarGapsAboveStop(self):
        ...
        # Buy. Stop >= 15. Buy <= 17.
        order = brk.createOptionStopLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, 15, 17, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
    ...
    def testBuySellPartial_ActivateAndThenFill(self):
        ...
        order = brk.createOptionStopLimitOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, 19, 20, 10, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        # 0 should get filled. The stop price should have not been hit.
    ...
    def testFillOpen(self):
        ...
        # Buy. Stop >= 10. Buy <= 12.
        order = brk.createOptionStopLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, stopPrice=10, limitPrice=12, quantity=1
                                               , right=optbroker.OptionOrder.Right.CALL, strike=20, expiry="2016-01-01")
        self.assertEqual(order.getFilled(), 0)
        self.assertEqual(order.getRemaining(), 1)
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        ...
        # Sell. Stop <= 8. Sell >= 6.
        order = brk.createOptionStopLimitOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, stopPrice=8, limitPrice=6, quantity=1
                                               , right=optbroker.OptionOrder.Right.CALL, strike=20, expiry="2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
    ...
    def testInvertedPrices_FillOpen(self):
        ...
        # Buy. Stop >= 12. Buy <= 10.
        order = brk.createOptionStopLimitOrder(optbroker.Order.Action.BUY, BaseTestCase.TestInstrument, stopPrice=12, limitPrice=10, quantity=1
                                               , right=optbroker.OptionOrder.Right.CALL, strike=20, expiry="2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
        ...
        # Sell. Stop <= 6. Sell >= 8.
        order = brk.createOptionStopLimitOrder(optbroker.Order.Action.SELL, BaseTestCase.TestInstrument, stopPrice=6, limitPrice=8, quantity=1
                                               , right=optbroker.OptionOrder.Right.CALL, strike=20, expiry="2016-01-01")
        self.assertEquals(order.getSubmitDateTime(), None)
        brk.submitOrder(order)
        self.assertEquals(order.getSubmitDateTime(), barFeed.getCurrentDateTime())
