...
from pyalgotrade.strategy.optstrategy import optposition
import strategy_opt_test
...
class BaseTestStrategy(optstrategy.OptionBacktestingStrategy):
...
class TestStrategy(BaseTestStrategy):
    ...
    def addPosExitMarket(self, dateTime, *args, **kwargs):
        ...
        self.__posExit[dateTime].append((optposition.Position.exitMarket, args, kwargs))

    def addPosExitLimit(self, dateTime, *args, **kwargs):
        self.__posExit.setdefault(dateTime, [])
        self.__posExit[dateTime].append((optposition.Position.exitLimit, args, kwargs))

    def addPosExitStop(self, dateTime, *args, **kwargs):
        self.__posExit.setdefault(dateTime, [])
        self.__posExit[dateTime].append((optposition.Position.exitStop, args, kwargs))

    def addPosExitStopLimit(self, dateTime, *args, **kwargs):
        self.__posExit.setdefault(dateTime, [])
        self.__posExit[dateTime].append((optposition.Position.exitStopLimit, args, kwargs))
    ...
    def onBars(self, bars):
        ...
        for meth, args, kwargs in strategy_opt_test.get_by_datetime_or_date(self.__posEntry, dateTime):
        ...
        # Check position exit.
        for meth, args, kwargs in strategy_opt_test.get_by_datetime_or_date(self.__posExit, dateTime):
            if self.__activePosition is None:
...
class EnterAndExitStrategy(BaseTestStrategy):
    ...
    def onBars(self, bars):
        if self.position is None:
            self.position = self.enterOptionLong(self.instrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
...
class LongPosTestCase(BaseTestCase):
    ...
    def testLongPosition(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 3), strat.enterOptionLong, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", False)
    ...
    def testLongPositionAdjClose(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 1, 18), strat.enterOptionLong, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", False)
    ...
    def testLongPositionGTC(self):
        ...
        # 2000-01-27,55.81,56.69,50.00,51.81,61061800,25.33 - enterOptionLong

        strat.addPosEntry(datetime.datetime(2000, 1, 27), strat.enterOptionLong, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", True)
    ...
    def testEntryCanceled(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 1, 27), strat.enterOptionLong, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", False)
        strat.run()
    ...
    def testUnrealized1(self):
        ...
        strat.addPosEntry(dt.localize(datetime.datetime(2011, 1, 3, 20, 53), pytz.utc), strat.enterOptionLong, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", True)
        strat.run()
    ...
    def testUnrealized2(self):
        ...
        strat.addPosEntry(datetime.date(2000, 12, 13), strat.enterOptionLong, instrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", False)  # Filled on 2000-12-14 at 29.25.
        strat.run()
    ...
    def testUnrealizedAdjusted(self):
        ...
        strat = TestStrategy(barFeed, instrument, 1000)
        strat.setUseAdjustedValues(True)
        strat.addPosEntry(datetime.date(2000, 12, 13), strat.enterOptionLong, instrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", False)  # Filled on 2000-12-14 at 28.60
        strat.run()
    ...
    def testActiveOrdersAndSharesLong(self):
        ...
        class Strategy(optstrategy.OptionBacktestingStrategy):
            ...
            def onBars(self, bars):
                if self.pos is None:
                    self.pos = self.enterOptionLong(instrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", True)
    ...
    def testPartialFillGTC1(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 1, 1), strat.enterOptionLong, instrument, 4, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", True)
...
class ShortPosTestCase(BaseTestCase):
    def testActiveOrdersAndSharesShort(self):
        ...
        class Strategy(optstrategy.OptionBacktestingStrategy):
            ...
            def onBars(self, bars):
                if self.pos is None:
                    self.pos = self.enterOptionShort(instrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", True)
                    # The entry order should be active.
                    testCase.assertEqual(len(self.pos.getActiveOrders()), 1)
                    testCase.assertEqual(self.pos.getShares(), 0)
                elif self.pos.isOpen():
    ...
    def testShortPosition(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 3), strat.enterOptionShort, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", False)
        strat.addPosExitMarket(datetime.datetime(2000, 11, 7))
        strat.run()
    ...
    def testShortPositionAdjClose(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 1, 18), strat.enterOptionShort, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", False)
        strat.addPosExitMarket(datetime.datetime(2000, 10, 12))
        strat.run()
    ...
    def testShortPositionExitCanceled(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 28), strat.enterOptionShort, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", False)
    ...
    def testShortPositionExitCanceledAndReSubmitted(self):
        ...
        # 2000-11-10,26.44,26.94,24.87,25.44,54614100,24.87 - enterOptionShort

        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterOptionShort, BaseTestCase.TestInstrument, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testUnrealized(self):
        ...
        strat.addPosEntry(dt.localize(datetime.datetime(2011, 1, 3, 20, 53), pytz.utc), strat.enterOptionShort, BaseTestCase.TestInstrument, 1,optbroker.OptionOrder.Right.CALL, 20, "2016-01-01",  True)
        strat.run()
        self.assertEqual(strat.enterOkCalls, 1)
        self.assertEqual(strat.exitOkCalls, 0)
        self.assertEqual(strat.enterCanceledCalls, 0)
...
class LimitPosTestCase(BaseTestCase):
    def testLong(self):
        ...
        # 2000-11-10,26.44,26.94,24.87,25.44,54614100,24.87 - enterOptionLongLimit

        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterOptionLongLimit, BaseTestCase.TestInstrument, 25, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testShort(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 16), strat.enterOptionShortLimit, BaseTestCase.TestInstrument, 29, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testExitOnEntryNotFilled(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterOptionLongLimit, BaseTestCase.TestInstrument, 5, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", True)
        strat.addPosExitLimit(datetime.datetime(2000, 11, 16), 29)
        strat.run()
    ...
    def testEntryGTCExitNotGTC(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterOptionLongLimit, BaseTestCase.TestInstrument, 25, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01", True)
...
class StopPosTestCase(BaseTestCase):
    def testLong(self):
        ...
        # 2000-11-14,27.37,28.50,26.50,28.37,77496700,27.74
        # 2000-11-13,25.12,25.87,23.50,24.75,61651900,24.20 - entry filled
        # 2000-11-10,26.44,26.94,24.87,25.44,54614100,24.87 - enterOptionLongStop

        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterOptionLongStop, BaseTestCase.TestInstrument, 25, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testShort(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 16), strat.enterOptionShortStop, BaseTestCase.TestInstrument, 27, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testPartialFillGTC1(self):
        ...
        bf.addBarsFromSequence(instrument, bars)
        strat = TestStrategy(bf, instrument, 1000)
        strat.addPosEntry(datetime.datetime(2000, 1, 1), strat.enterOptionLongStop, instrument, 12, 4, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01",True)
        strat.addPosExitMarket(datetime.datetime(2000, 1, 4))
        strat.run()
...
class StopLimitPosTestCase(BaseTestCase):
    def testLong(self):
        ...
        # 2000-11-14,27.37,28.50,26.50,28.37,77496700,27.74
        # 2000-11-13,25.12,25.87,23.50,24.75,61651900,24.20 - entry filled
        # 2000-11-10,26.44,26.94,24.87,25.44,54614100,24.87 - enterOptionLongStopLimit

        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterOptionLongStopLimit, BaseTestCase.TestInstrument, 25.5, 24, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
    ...
    def testShort(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 16), strat.enterOptionShortStopLimit, BaseTestCase.TestInstrument, 27, 29, 1, optbroker.OptionOrder.Right.CALL, 20, "2016-01-01")
